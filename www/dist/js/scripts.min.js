...
var Spotify=function(t){var e="undefined"!=typeof jQuery,o=4371,n="",r=!1,s=function(t,n){var r=function(){return Math.random().toString(36).replace(/[^a-z]+/g,"").substr(0,10)+"."};if(e){var s={url:"https://"+r()+"spotilocal.com:"+o+t,error:function(t,e){n&&n(e)},success:function(t){var e=t;n&&n(e)}};$.get(s)}else{var u=new XMLHttpRequest;u.open("GET","https://"+r()+"spotilocal.com:"+o+t,!0),u.onload=function(){if(u.status>=200&&u.status<400){var t=JSON.parse(u.responseText);n&&n(t)}else n&&n("error")},u.onerror=function(){n&&n("error")},u.send()}};this.ready=function i(u){return r?(u&&u(),!0):void s("/service/version.json?service=remote",function(a){if("error"===a&&o<4380)o+=1,i(u);else if("error"===a&&o>=4380)u&&u("Spotify application is not running or doesn't support the internal web server.");else if(e)$.ajax({url:"/oauthtoken",method:"GET",success:function(e){"string"==typeof e&&(e=JSON.parse(e)),n=e.t,s("/remote/status.json?csrf="+t+"&oauth="+n+"&returnon=login%2Clogout%2Cplay%2Cpause%2Cerror%2Cap&returnafter=1",function(t){"undefined"!=typeof t.error&&"4107"===t.error.type?(o+=1,i(u)):"undefined"!=typeof t.error&&"4107"===t.error.type&&o>=4380?u&&u("invalid CSRF token"):(u&&u(),r=!0)})}});else{var f=new XMLHttpRequest;f.open("GET","/oauthtoken",!0),f.onload=function(){if(f.status>=200&&f.status<400){var e=JSON.parse(f.responseText);n=e.t,s("/remote/status.json?csrf="+t+"&oauth="+n,function(t){"undefined"!=typeof t.error&&"4107"===t.error.type?u&&u("invalid CSRF token"):(u&&u(),r=!0)})}else u&&u("error")},f.onerror=function(){u&&u("error")},f.send()}})},this.status=function(e,o,r){"function"==typeof e&&(r=e,e=void 0),"function"==typeof o&&(r=o,o=void 0),s("/remote/status.json?csrf="+t+"&oauth="+n+(e?"&returnon="+e:"")+(o?"&returnafter="+o:""),function(t){r&&r(t)})},this.play=function(e,o,r){e&&"string"==typeof e?s("/remote/play.json?csrf="+t+"&oauth="+n+"&uri="+encodeURIComponent(e+(o?"#"+o:"")),function(t){r&&r(t)}):s("/remote/pause.json?csrf="+t+"&oauth="+n+"&pause=false",function(t){(r||"function"==typeof e)&&(r=e)(t)})},this.toggle=function(e){this.status(function(o){s("/remote/pause.json?csrf="+t+"&oauth="+n+"&pause="+o.playing,function(t){e&&e(t)})})},this.pause=function(e){s("/remote/pause.json?csrf="+t+"&oauth="+n+"&pause=true",function(t){e&&e(t)})};var u={};this.on=function a(e,o,r){var i=!1;window.onbeforeunload=function(){i=!0},"function"==typeof o&&(r=o,o=void 0),r&&(u[e]=r),r||delete u[e],s("/remote/status.json?csrf="+t+"&oauth="+n+"&returnon="+e+(o?"&returnafter="+o:"&returnafter=0"),function(t){u[e]&&!i&&(u[e](t),a(e,o,u[e]))})}};
